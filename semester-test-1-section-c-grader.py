...
if image is not None:
    ...
    answer = cv.rectangle(answer, (165,290), (200, 325), (0, 0, 255), 1, 8, 0)
    answer = cv.rectangle(answer, (419, 543), (454, 578), (0, 0, 255), 1, 8, 0)
    ...
    if st.button("Grade"):
        ...
        final_img = cv.putText(img=warped_img, text=f'{int(st.session_state.chk9) + int(st.session_state.chk10)}',
                               ...
                               fontScale=1, color=(0, 0, 255), thickness=1)
        final_img = cv.putText(img=final_img, text=f'{grade}', org=(650, 150),
                               fontFace=cv.FONT_HERSHEY_SIMPLEX,
